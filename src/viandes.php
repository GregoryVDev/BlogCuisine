...
$sql_article = "SELECT a.article_id, p.number, c.category_name, t.tag_name, a.username, a.title, a.cooking, a.preparation, a.content, a.date, a.ingredients, a.instruction, a.image 
    FROM article a 
