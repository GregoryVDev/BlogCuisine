...
function toggleDropdown(event) {
  ...
  document.querySelector(".container-tags-form").classList.toggle("active");
}

// Ferme le dropdown quand on clique sur la page n'importe où
window.onclick = function (event) {
  // Vérifie si le dropdown est ouvert
  const dropdownContainer = document.querySelector(".container-tags-form");
  if (
    ...
    !event.target.closest(".container-tags-form")
  ) {
